...
def train_step(inputs, labels):
    """Performs a single training step with learning rate decay."""
...
# Visualization
plt.plot(range(total_iterations), learning_rates, marker='o', linestyle='-')
plt.xlabel('Global Step')
plt.ylabel('Learning Rate')
plt.title('Learning Rate Decay in TensorFlow')
plt.show()
