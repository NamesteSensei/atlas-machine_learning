...
/**
   ...
   including an upgraded training method that can display progress and plot cost.
*/
"""
    ...
    */
    ...
    def train(self, X, Y, iterations=5000, alpha=0.05, verbose=True, graph=True, step=100):
        ...
        /**
           ...
           or if step is not a positive integer less than or equal to iterations when verbose or graph is enabled.
