...
/**
   ...
   including persistence methods to save the instance and load it back.
*/
"""
    ...
    */
    ...
    def forward_prop(self, X):
        ...
        /**
           ...
           The input is stored in __cache with key A0; subsequent activations are stored with key A{level}.
           Uses the sigmoid activation at every level.
    ...
    def cost(self, Y, A):
        ...
        /**
           ...
           A is a numpy.ndarray with shape (1, m) of outputs.
           Returns the cost.
        */
        """
        m = Y.shape[1]
    ...
    def save(self, filename):
        """
        /**
           Saves the current instance to a file in pickle format.
           filename is the destination; if it does not end with ".pkl", the extension is appended.
        */
        """
    ...
    def load(filename):
        ...
        /**
           ...
           Returns the loaded instance, or None if the file is not found.
        */
        """
        try:
